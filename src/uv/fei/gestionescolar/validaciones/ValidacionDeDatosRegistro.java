 ...
 */
package uv.fei.gestionescolar.validaciones;
...
public class ValidacionDeDatosRegistro {
    ...
    /**
     * Verifica que una cadena incluya los caracteres permitidos en una contraseña 
     * ({'.', '_', '-', '@'}, números y letras), que no 
     * incluya acentos ni espacios.
     * @param contraseñaAEvaluar
     * @return true si la cadena pasa los criterios, 
     *              false en caso contrario.
     */
    public boolean validarContraseña (String contraseñaAEvaluar){
        /**
         * ASCII 46 = '.'
         * ASCII 45 = '_'
         * ASCII 95 = '-'
        ...
        letras();
        boolean cadenaValida = true;
        for (int i = 0; i < contraseñaAEvaluar.length() && cadenaValida == true; i++){
            if(abecedario[contraseñaAEvaluar.charAt(i)] == false){
                cadenaValida=false;
            }
        }
        abecedario[46] = false;
    ...
    /**
     * Verifica que una cadena números y letras que son permitidos en un usuario), que no 
     * incluya acentos ni espacios ni caracteres especiales.
     * @param usuarioAEvaluar
     * @return true si la cadena pasa los criterios, 
     *              false en caso contrario.
     */
    public boolean validarUsuario (String usuarioAEvaluar){
        /**
         * ASCII 46 = '.'
         * ASCII 45 = '_'
         * ASCII 95 = '-'
        ...
        letras();
        boolean cadenaValida = true;
        for (int i = 0; i < usuarioAEvaluar.length() && cadenaValida == true; i++){
            if(abecedario[usuarioAEvaluar.charAt(i)] == false){
                cadenaValida=false;
            }
        }
        abecedario[46] = false;
